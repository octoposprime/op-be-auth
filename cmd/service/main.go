...
import (
	...
	pa_command "github.com/octoposprime/op-be-auth/internal/application/presentation/adapter/command"
	pa_query "github.com/octoposprime/op-be-auth/internal/application/presentation/adapter/query"
	as "github.com/octoposprime/op-be-auth/internal/application/service"
	ds "github.com/octoposprime/op-be-auth/internal/domain/service"
	ia_ebus "github.com/octoposprime/op-be-auth/pkg/infrastructure/adapter/ebus"
	ia_repo "github.com/octoposprime/op-be-auth/pkg/infrastructure/adapter/repository"
	ia_service "github.com/octoposprime/op-be-auth/pkg/infrastructure/adapter/service"
	pc_grpc "github.com/octoposprime/op-be-auth/pkg/presentation/controller/grpc"
	pc_probe "github.com/octoposprime/op-be-auth/pkg/presentation/controller/probe"
	tseed "github.com/octoposprime/op-be-auth/tool/config"
